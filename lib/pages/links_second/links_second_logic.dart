...
class LinksSecondLogic extends GetxController {

  aboutLinksPrivacy(BuildContext context) async {
...
If you have any questions or concerns about our privacy policy, please contact us via email.
  ...
  aboutLinksUS(BuildContext context) async {
    ...
    showAboutDialog(
      ...
      children: [
        const Text(
            """We can record your water and electrical usage records"""),
      ],
      context: context,
    );
  }
